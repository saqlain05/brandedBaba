						...
						<div className='flex justify-between'>
							<div>
								...
								<Typography color='textSecondary'>
									{`${props.order.address.full_address}, ${props.order.address.city}, ${props.order.address.state}, ${props.order.address.pincode}`}
								</Typography>
							...
							<div className={clsx(classes.seller, "flex items-center p-16")}>
								...
								<div
									className={clsx(classes.divider, "divider ml-8 mr-16 h-96")}
								/>

								<div>
									<Typography color='inherit'>Branded Baba</Typography>

									<Typography color='inherit'>New Delhi</Typography>
									<Typography color='inherit'>+66 123 455 87</Typography>
									<Typography color='inherit'>hello@brandedbaba.in</Typography>
									<Typography color='inherit'>www.brandedbaba.in</Typography>
								</div>
							</div>
						</div>
									...
									{props.order.items.map((product) => (
										<TableRow key={product.id}>
											...
											<TableCell align='right'>
												{formatter.format(product.product_info.mrp)}
											</TableCell>
											<TableCell align='right'>{product.quantity}</TableCell>
											<TableCell align='right'>
												{formatter.format(
													product.product_info.mrp * product.quantity
												)}
											</TableCell>
										</TableRow>
									))}
									...
									<TableRow>
										...
										<TableCell align='right'>
											<Typography
												...
												variant='h4'
												color='textSecondary'>
												{formatter.format(props.order.total_amount)}
											</Typography>
										</TableCell>
									</TableRow>
								</TableBody>
